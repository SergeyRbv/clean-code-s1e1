...
alert('У меня все сломалось, пожалуйста, проверьте чуть позднее');
...
var completedTasksHolder=document.getElementById("item-complited__list");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.classList.add("btn-delete");
...
var taskCompleted=function(){
    ...
    listItem.children[1].classList.add("item-complited__label");
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    listItem.children[1].classList.remove("item-complited__label");
    bindTaskEvents(listItem,taskCompleted);
}
